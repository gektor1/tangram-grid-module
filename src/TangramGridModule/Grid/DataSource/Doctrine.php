 ...
 * Grid which will both create all neccasary javascript and JSON for drawing
 * a grid with JQgrid.
 *
    ...
    public function __construct($source)
    {
        ...
        switch($source) {
            ...
            case ($source instanceof \Doctrine\ORM\EntityRepository) :
                ...
                break;
            default :
                throw new \Exception('Unknown source given, source must either be an entity, query or querybuilder object.');
                break;
        }
